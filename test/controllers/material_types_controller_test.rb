...
class MaterialTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material_type" do
    assert_difference('MaterialType.count') do
      post material_types_url, params: { material_type: { is_active: @material_type.is_active, name: @material_type.name } }
    end
  ...
  test "should update material_type" do
    patch material_type_url(@material_type), params: { material_type: { is_active: @material_type.is_active, name: @material_type.name } }
