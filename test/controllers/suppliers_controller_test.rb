...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { is_active: @supplier.is_active, name: @supplier.name } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { is_active: @supplier.is_active, name: @supplier.name } }
