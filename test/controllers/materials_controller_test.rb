...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { is_active: @material.is_active, name: @material.name } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { is_active: @material.is_active, name: @material.name } }
